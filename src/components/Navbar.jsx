  ...
  return (
      <div className='bg-navbar p-3 grid grid-cols-2 w-full'>
          ...
          <div className='flex justify-end items-center'> 
            <a href='https://github.com/RahulBishnoi-29/' target='_blank' rel='noopener noreferrer'>
                <AiFillGithub className='text-4xl ml-1.5 mr-1.5 ' />
            </a>
            <a href='https://www.linkedin.com/in/rahul-bishnoi-796507248/' target='_blank' rel='noopener noreferrer'>
